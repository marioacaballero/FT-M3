...
async function problemB() {
  ...
  // AsyncAwait version
  const res1 = await promisifiedReadFile("poem-one/stanza-02.txt");
  blue(res1);
  const res2 = await promisifiedReadFile("poem-one/stanza-03.txt");
  blue(res2);
}
...
async function problemD() {
  ...
  // AsyncAwait version
  try {
    const res1 = await promisifiedReadFile("poem-one/wrong-file-name.txt");
    blue(res1);
  } catch (error) {
    magenta(error);
  }
...
async function problemE() {
  ...
  // AsyncAwait version
  try {
    const res1 = await promisifiedReadFile("poem-one/stanza-03.txt");
    blue(res1);
    const res2 = await promisifiedReadFile("poem-one/wrong-file-name.txt");
    blue(res2);
  } catch (error) {
    magenta(error);
  }
